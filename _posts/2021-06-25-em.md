...
algorithm based on Jensen's inequality. This post will be concerned with deriving the EM algorithm from first principles, exploring use cases, such as optimizing mixtures of Gaussians, relating it to variational inference using the reparameterization trick, and showing how it is conceptually similar to Trust Region Policy Optimization. We then walk through conjugate gradient descent, line search, and implement TRPO.

I am indebted to these wonderful [notes](http://cs229.stanford.edu/notes2020spring/cs229-notes8.pdf) by Tengyu Ma. 
