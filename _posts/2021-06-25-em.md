...
Computing the gradient over $$\phi$$ and $$\psi$$ is tricky because $$Q_{i}$$ depends on them, and we're taking the expectation over $$Q_{i}$$. This is where the re-parameterization trick comes in handy.
