...
In the case that $$z$$ is high dimensional and discrete, one popular assumption is the mean field assumption, i.e. that. $$Q_{i}(z)$ is a distribution with independent coordinates. 
