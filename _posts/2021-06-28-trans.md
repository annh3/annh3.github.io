...
**Alice**: I’m curious what Sapolsky would say about the perspective that gender is situational. For example, when I am in certain career contexts, but not all, I behave in more masculine, or “tech bro” ways to adapt to the norms. I wonder if there are neural correlates of code switching gender. Are the influences Sapolsky highlights genetic, epigenetic (subject to environmental activation), or hormonal, which is also context dependent? Or can they be on the level of default mode thinking vs non default mode thinking--like Kahneman's Thinking Fast and Slow?
