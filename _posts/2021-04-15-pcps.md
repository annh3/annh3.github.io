...
> Topics touched on: discrete random processes, randomized algorithms, probabilistic proof systems, exponential time hypothesis, lower bounds, random set cover, birthday paradox, PAC learning theory
