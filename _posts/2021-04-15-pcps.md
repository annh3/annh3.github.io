...
What we care about is the distance between two distributions--the distribution that the verifier sees when sampling from a string in $$\mathcal{S}$$ and the distribution that it sees when sampling from a string in $$\mathcal{S}'$$.
