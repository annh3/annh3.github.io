...
> Topics touched on: probabilistically checkable proofs, discrete random processes, probabilistic method, exponential time hypothesis, lower bounds, random set cover, birthday paradox, PAC learning theory
